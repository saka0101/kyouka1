...
PATH_BLANK = '/Users/yutasakamaki/Downloads/保存用/iRL/main/image/blank.png'            # 空白（床）(E)
PATH_ROBOT = '/Users/yutasakamaki/Downloads/保存用/iRL/main/image/robo_right.png'       # ロボット画像 (F)
PATH_CRYSTAL = '/Users/yutasakamaki/Downloads/保存用/iRL/main/image/crystal_small.png'  # クリスタル画像 (G)
